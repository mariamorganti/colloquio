...
public partial class Operazioni
{
    ...
    public virtual ICollection<OperazioniOtp> OperazioniOtps { get; set; } = new List<OperazioniOtp>();

    public virtual ICollection<OperazioniRicevute> OperazioniRicevutes { get; set; } = new List<OperazioniRicevute>();
}
