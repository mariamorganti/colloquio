...
public partial class Tracce
{
    ...
    public int? VersioneSw { get; set; }

    public DateTime? DataLetturaKafkaGdF { get; set; }

    public DateTime? DataCreazioneCdcgdf { get; set; }

    public DateTime? DataLetturaKafkaDema { get; set; }

    public DateTime? DataCreazioneCdcdema { get; set; }
}
